...
import uk.ac.cam.cl.mlrd.exercises.markov_models.Exercise7;
import uk.ac.cam.cl.mlrd.exercises.markov_models.Exercise8;
...
public class Exercise8Tester {
    ...
    public static void main(String[] args)
        ...
        for (int i = 0; i < predicted.size(); i++){
            if (predicted.get(i) == DiceType.WEIGHTED) w++;
            if (predicted.get(i) == DiceType.FAIR) f++;
        }
