...
public class Exercise6Tester {
    ...
    static final Path dataDirectory = Paths.get("data/nuanced_sentiment_dataset/nuanced_sentiment_dataset");
    ...
    public static void main(String[] args) throws IOException {
        ...
        table34.put(1, agreementTable.get(3));
        table34.put(2, agreementTable.get(4));
        double kappa34 = implementation.kappa(table34);
        System.out.println("Kappa value for reviews 3 and 4:");
        System.out.println(kappa34);
        System.out.println();

        //Exercise6 implementation = (Exercise6) new Exercise6();
        //List<Map<Path, NuancedSentiment>> randomFolds = implementation.splitCVStratifiedRandom(dataSet, seed);
...
//        System.out.println("CV score for folds split stratified: ");
